...
part 'web_books_classes_adapter.g.dart';

class WebBooksClassesAdapter {
  WebBooksClassesAdapter();

  @Route.get("/")
  Response _getAllBooksClassess(Request request) {
  ...
  Router get router => _$WebBooksClassesAdapterRouter(this);
}
