...
part 'web_transaction_adapter.g.dart';

class WebTransactionAdapter {
  WebTransactionAdapter();
  ...
  Response _getAllTransactions(Request request) {
    ...
    return switch (validationError) {
      null => CustomResponse.ok(
        DatabaseManager.transactionDao.getTransactions(
  ...
  Router get router => _$WebTransactionAdapterRouter(this);
}
